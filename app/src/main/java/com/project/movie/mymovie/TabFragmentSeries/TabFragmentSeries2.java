 ...
 */
public class TabFragmentSeries2 extends Fragment {
    ...
    private void getAiringTodayTvSeries() {
        ...
        service.getAiringTodayTvSeries(new Callback<SeasonModel.SeasonResult>() {
            @Override
